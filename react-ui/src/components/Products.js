...
export default function Products() {
  ...
  const handleDelete = async (id)  => {
    ...
    try {
        await axiosInstance.delete(`http://localhost:8083/product/${id}`);
  ...
  const handleEditProduct = async () => {
    setSnackbarOpen(true)
    try {
        const response = await axiosInstance.put(`http://localhost:8083/product/${editProduct.id}`, {
            ...editProduct,
  ...
  const handleAddProduct = async () => {
    setSnackbarOpen(true)
    try {
        const response = await axiosInstance.post('http://localhost:8083/products', {
            ...newProduct,
  ...
  // Helper function to get category title by categoryid
  ...
  useEffect(() => {
    axiosInstance.get('http://localhost:8083/products').then(response => {
  ...
  useEffect(() => {
    axiosInstance.get('http://localhost:8083/categories').then(response => {
  ...
  useEffect(() => {
    axiosInstance.get('http://localhost:8083/subCategories').then(response => {
        ...
        <Table aria-label="simple table">
            ...
            <TableBody>
              ...
              >
                ...
                <TableCell sx={{ fontSize: '1.1rem' }}>{product.category ? product.category.title : getCategoryTitle(product.categoryid)}</TableCell>
